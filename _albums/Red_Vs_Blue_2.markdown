                        ...
                        <div class="text pt-5 pl-0 px-lg-5 pl-md-4 ftco-animate">
                            <div class="px-4 px-lg-4">
                                <div class="desc text-md-right">
                                    <div class="top">
                                        <span class="subheading">2007 | Michael Lubin</span>
                                        <h2 class="mb-4">Red Vs Blue 2</h2>
                                    </div>
                                    <div class="absolute">
                                        ...
                                        <img src="{{ site.baseurl | prepend: site.url }}/images/RVB.jpg" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- BEGIN Player -->
                        <div class="container d-flex align-items-center justify-content-center col-md-6 line-left">
                            <div id="wrapper">
                                <audio preload></audio>
                                <ol>
                                    <li><a href="#" data-src="{{ site.baseurl | prepend: site.url }}/audio/RVB2.mp3">Red Vs Blue 2</a></li>
                                </ol>
                            </div>
                                                                    </div>
                    <!-- END Player -->
